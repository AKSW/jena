...
//     * @param srsURI
//     */
//    public SpatialIndexNode(int capacity, String srsURI) {
...
//     */
//    public SpatialIndexNode(Collection<SpatialIndexItem> spatialIndexItems, String srsURI) throws SpatialIndexException {
//        // named graphs
...
//     * @throws SpatialIndexException
//     */
//    public static final SpatialIndexNode retrieve(ExecutionContext execCxt) throws SpatialIndexException {
//
//        Context context = execCxt.getContext();
//        SpatialIndexNode spatialIndex = (SpatialIndexNode) context.get(SPATIAL_INDEX_SYMBOL, null);
//
...
//     * @param spatialIndex
//     */
//    public static final void setSpatialIndex(Dataset dataset, SpatialIndexNode spatialIndex) {
...
//     * @throws SpatialIndexException
//     */
//    public static SpatialIndexNode buildSpatialIndex(Dataset dataset, String srsURI, File spatialIndexFile) throws SpatialIndexException {
//
//        SpatialIndexNode spatialIndex = load(spatialIndexFile);
//
...
//            spatialIndex = new SpatialIndexNode(spatialIndexItems, srsURI);
//            spatialIndex.build();
//        }
//
...
//     * @throws SpatialIndexException
//     */
//    public static SpatialIndexNode buildSpatialIndex(Dataset dataset, File spatialIndexFile) throws SpatialIndexException {
//        String srsURI = GeoSPARQLOperations.findModeSRS(dataset);
//        SpatialIndexNode spatialIndex = buildSpatialIndex(dataset, srsURI, spatialIndexFile);
//        return spatialIndex;
//    }
//
//    /**
...
//     * @throws SpatialIndexException
//     */
//    public static SpatialIndexNode buildSpatialIndex(Dataset dataset, String srsURI) throws SpatialIndexException {
//        LOGGER.info("Building Spatial Index - Started");
//
//        Collection<SpatialIndexItem> items = findSpatialIndexItems(dataset, srsURI);
//        SpatialIndexNode spatialIndex = new SpatialIndexNode(items, srsURI);
//        spatialIndex.build();
//        setSpatialIndex(dataset, spatialIndex);
...
//        Graph defaultModel = dataset.getDefaultModel().getGraph();
...
//     * @throws SpatialIndexException
//     */
//    public static SpatialIndexNode buildSpatialIndex(Dataset dataset) throws SpatialIndexException {
//        String srsURI = GeoSPARQLOperations.findModeSRS(dataset);
//        SpatialIndexNode spatialIndex = buildSpatialIndex(dataset, srsURI);
//        return spatialIndex;
//    }
//
//    /**
...
//     * @throws SpatialIndexException
//     */
//    public static final Collection<SpatialIndexItem> getSpatialIndexItems(Graph graph, String srsURI) throws SpatialIndexException {
//
...
//        if (graph.contains(null, Geo.HAS_GEOMETRY_PROP.asNode(), null)) {
//            LOGGER.info("Feature-hasGeometry-Geometry statements found.");
//            if (graph.contains(null, SpatialExtension.GEO_LAT_PROP.asNode(), null)) {
...
//     * @throws SpatialIndexException
//     */
//    private static Collection<SpatialIndexItem> getGeometryLiteralIndexItems(Graph graph, String srsURI) throws SpatialIndexException {
//        List<SpatialIndexItem> items = new ArrayList<>();
//        ExtendedIterator<Triple> stmtIt = graph.find(null, Geo.HAS_GEOMETRY_PROP.asNode(), null);
//        while (stmtIt.hasNext()) {
//            Triple t = stmtIt.next();
//
//            Node feature = t.getSubject();
//            Node geometry = t.getObject();
//
//
//            ExtendedIterator<Node> nodeIter = GraphUtil.listObjects(graph, geometry, Geo.HAS_SERIALIZATION_PROP.asNode());
//            if (!nodeIter.hasNext()) {
//                ExtendedIterator<Node> wktNodeIter =GraphUtil.listObjects(graph, geometry, Geo.AS_WKT_PROP.asNode());
//                ExtendedIterator<Node> gmlNodeIter = GraphUtil.listObjects(graph, geometry, Geo.AS_GML_PROP.asNode());
//                nodeIter = wktNodeIter.andThen(gmlNodeIter);
//            }
//
//            while (nodeIter.hasNext()) {
//                Node geometryLiteral = nodeIter.next();
...
//     * @throws SpatialIndexException
//     */
//    public static final SpatialIndexNode load(File spatialIndexFile) throws SpatialIndexException {
//
...
//                SpatialIndexNode spatialIndex = (SpatialIndexNode) in.readObject();
