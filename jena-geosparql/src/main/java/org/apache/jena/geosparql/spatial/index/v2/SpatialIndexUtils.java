...
public class SpatialIndexUtils {
     ...
     * @throws SpatialIndexException
     */
    public static SpatialIndex buildSpatialIndex(DatasetGraph datasetGraph, String srsURI) throws SpatialIndexException {
        return buildSpatialIndex(datasetGraph, srsURI, true);
    }
