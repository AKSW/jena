...
/**
 * <a href="https://jena.apache.org/documentation/notes/sse.html" >SPARQL
 * S-Expressions</a> is a unstandardized format for SPARQL-related and now
 * RDF-related objects. This includes use for writing down the SPARQL algebra in
 * Apache Jena ARQ.
 * <p>
 * It has regular syntax, inspired by schema (lisp), making it easy to create and
 * maintain builders and writers and to compose structures.
 * <p>
 ...
 * </ul>
 * <p>
 * {@code parse(...)}, which produces a {@link Item}, is direct access to the syntax
 * parser. Builders take parser {@code Item} and create the in-memory objects
 * (package {@code org.apache.jena.sparql.sse.builders}) and writers output in-memory
 * objects to an {@link IndentedWriter} (package
 * {@code org.apache.jena.sparql.sse.writers}.
 * <p>
 ...
 * <p>
 * Efficiency at scale is not a primary design goal, though the core parser is
 * streaming and would scale.
 */
public class SSE {
    static {
        JenaSystem.init();
    ...
    /**
     * Parse a string and obtain a SPARQL algebra basic graph pattern, given a prefix
     * mapping
     */
    ...
    /**
     * Parse a string and obtain an SSE item expression (no additional prefix
     * mappings)
     */
    ...
    /**
     * The parser process. This includes lifting compound nodes and converting symbol
     * constants. The reverse is in BuilderExpr node (direct to output) and
     * ItemLift.reverse
     */
